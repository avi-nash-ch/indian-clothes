                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-5">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Edit Banner 1</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary card-outline">
                            <form action={{route('promotionalBanner.update', encrypt($promotionalBanner->id))}} method="POST" enctype="multipart/form-data">
                            @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name" required  value="{{old('name', $promotionalBanner->name)}}" placeholder="Enter Name">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <img src="{{getImageUrl($promotionalBanner->image)}}" id="profile-img-tag"  width="192px" height="192px" class="mt-2"><br>
                                            </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{route('promotionalBanner.index')}}" class="btn btn-primary">Return</a>
