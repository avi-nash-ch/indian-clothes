            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline">
                        <form action={{route('unit.update', encrypt($unit->id))}} method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" required value="{{old('name', $unit->name)}}" value="{{old('Unit')}}" placeholder="Enter Unit">
