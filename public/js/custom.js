...
(function ($) {
    ...
    //     alert($("#email").val())
        ...
        //         } else if (element.prev().hasClass('input-group-prepend')) {
        //             error.insertAfter(element.parent());
        //         } else if (element.parent().hasClass('iti--separate-dial-code')) {
        //             error.insertAfter(element.closest('.custom-field'));
        //         } else {
        //             // error.insertAfter(element.next('.placeholder'));
        //             error.insertAfter(element.parent());
        //         }
        //     },
        //     errorElement: "div"
    ...
    // $('#submitButtonpop').click(function () {
    //     var currentUrl = window.location.href;
    //     var csrfToken = $('meta[name="csrf-token"]').attr('content');

    //     let nameapp = $('#nameapp').val();
    //     let emailapp = $('#mailapp').val();
    //     let numberapp = $('#tel-app').val();
    //     let appointment_for = $('#appointment_for').val();
    //     let date = $('#date').val();
    ...
    //             // $('.bts-popup').hide();
    //             $('.bts-popup').attr('style', 'display: none;');
    //         },
