                        ...
                        <div class="card card-primary card-outline" style="overflow-x: auto;">
                            ...
                            <div class="row mb-7 mt-3 mr-3">
                                ...
                                <div class="col-sm-2 text-end">
                                    <a href="{{route('delivery-boy-management.index')}}" class="btn btn-block btn-secondary">Back</a>
                                </div>
                            </div>
                            <hr>

                            <div class="card-body">
                                <table class="table table-bordered" id="deliveryBoyTable">
                                    <thead>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td>
                                                <div>
                                                    ...
                                                    <a href="{{ url('/admin/delivery-boy-management/'.encrypt($deliveryboymanagement->id).'/orders') }}" class="mr-3" title="Orders"><i class="fa fa-eye bts-popup-close mt-2"></i></a>
