                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary card-outline">
                            <form action={{route('bestSeller.update', encrypt($bestSeller->id))}} method="POST" enctype="multipart/form-data">
                            @csrf
                                <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select id="product_id" name="product_id" class="js-example-basic-multiple form-control select2" required="">
                                                    ...
                                                    @foreach($products as $product)
                                                        <option value="{{ $product->id }}" @if(old('product_id', $bestSeller->product_id) == $product->id) selected @endif>{{ $product->name }}</option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{route('bestSeller.index')}}" class="btn btn-primary">Return</a>
