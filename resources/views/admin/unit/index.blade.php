                        ...
                        <div class="card card-primary card-outline" style="overflow-x: auto;">
                            ...
                            <div class="row mb-7 mt-3 mr-3">
                                ...
                                <div class="col-sm-2 text-end">
                                    <a href="{{route('unit.create')}}" class="btn btn-block btn-primary">Add</a>
                                </div>
                            </div>
                            <hr>
                                ...
                                <table class="table table-bordered" id="categoryTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <a href="{{ url('admin/unit/'.encrypt($unit->id).'/edit') }}" class="mr-3"><i class="fa fa-edit bts-popup-close mt-2"></i></a>

                                                    <a href="#" onclick="confirmDelete('{{ encrypt($unit->id) }}')"><i class="fa fa-times bts-popup-close mt-2"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        @endforeach
...
<script>
    function confirmDelete(id) {
        ...
        if (result) {
            ...
            window.location.href = "{{ url('admin/unit/') }}/" + id + "/delete";
        } else {
